...
/**
 * {@code DemoGlobalSentinelConfigRegister}
 *
 * @author zhangxiang
 * @since 2024/12/13
 */
@Component
public class DemoGlobalSentinelConfigRegister implements GlobalSentinelConfigRegister {
    @Override
    public SentinelDegradeRule get() {
